...
public class FriendAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public interface FriendAddAdapterListener {
        void onItemSelected(Friend friend);
    }

    FriendAdapter.FriendAddAdapterListener listener;
    ...
    public void setListener(FriendAddAdapterListener listener) {
