...
import com.example.project2.ui.present.friend.FriendAddDialogFragment;
...
public class PresentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, final int position) {
                ...
                presentSponsorViewHolder.sponsorAdd.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if(currentPresent.getNumFilled() >= currentPresent.getNumNeeded()) {
                            ...
                            showPresentMessageDialog(currentPresent);
                        }
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                openPresentDetailFragment(currentPresent);
            }
        } );
    }
    ...
    public void openPresentDetailFragment(Present present) {
        PresentDetailFragment fragment =
                PresentDetailFragment.newInstance(present);
    ...
    public void showPresentMessageDialog(Present present) {
        DialogFragment dialog = new PresentMessageDialogFragment(present);
